...
const App = () => {
  ...
  if(clicks.good !==0 || totalclicks !==0)          // If was needed otherwise it would try to divide 0 by 0. 
    _clickpercentage = clicks.good/totalclicks * 100
